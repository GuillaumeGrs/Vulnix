...
# Filter report data based on user's choice
filtered_results = []
...
if tokens_total > MAX_INPUT_TOKENS:
    print(f"[!] Input too large ({tokens_total} tokens). Trimming is required or scan must be refined.")
    print("[*] Try using '--light-scan' or choosing 'high' severity only.")
    sys.exit(1)
